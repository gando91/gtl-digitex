...
public static final int MAXPLAYERS = 2;
	...
	public void onReceivedPacket(IPacket packet) {
		...
		if(packet instanceof ResponsePacket){
			...
			if ( ((ResponsePacket)packet).getResponse() == 1 || ((ResponsePacket)packet).getResponse() == 2 || ((ResponsePacket)packet).getResponse() == 2000 || ((ResponsePacket)packet).getResponse() == 1500 || ((ResponsePacket)packet).getResponse() == 1200 || ((ResponsePacket)packet).getResponse() == 99){
